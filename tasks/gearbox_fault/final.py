...
# PSO
classifiers = {
    "Logistic Regression": LogisticRegression(C=37.6, max_iter=547),
    "Ridge Classifier": RidgeClassifier(alpha=37.6, max_iter=547),
    "Decision Tree": DecisionTreeClassifier(max_depth=11),
    "Random Forest": RandomForestClassifier(n_estimators=128, max_depth=11),
    "AdaBoost": AdaBoostClassifier(n_estimators=128),
    "Gradient Boosting": GradientBoostingClassifier(n_estimators=128, max_depth=11)
}
# non-PSO
# classifiers = {
